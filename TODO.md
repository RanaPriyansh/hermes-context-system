# TODO - hermes-context-system

Repository: https://github.com/RanaPriyansh/hermes-context-system.git
Canonical local path: /root/git-repos/hermes-context-system
Default branch: main
...
3. Run the local setup path for hermes-context-system and write exact commands back into README if they are missing or stale.
